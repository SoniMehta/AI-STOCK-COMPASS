...
//     try {
//       // Use simple insights - LLM only, no stock API data fetching
//       const data = await stocks.getSimpleInsights(stockTicker.toUpperCase());

//       // Convert simple insights format to expected result format
//       setResult({
...
//         description: error.message || "Failed to analyze stock. The AI service may be temporarily unavailable.",
//         variant: "destructive",
//       });
//     } finally {
...
//                             {(result.market.support || result.market.resistance) && (
//                               <div className="grid grid-cols-2 gap-4">
//                                 {result.market.support && (
...
//                               </div>
//                             )}
//                             <p className="text-sm text-muted-foreground whitespace-pre-wrap">{result.market.summary}</p>
//                             <ConfidenceBar value={result.market.confidence * 100} label="Confidence" />
//                           </div>
//                         </motion.div>
//                       )}
//                     </AnimatePresence>
...
//                               Analyzed <span className="font-medium text-foreground">{result.sentiment.articles_analyzed}</span> articles
//                             </p>
//                             {result.sentiment.headlines && result.sentiment.headlines.length > 0 && (
//                               <div className="space-y-2">
//                                 <p className="text-sm font-medium text-foreground">Key Headlines:</p>
//                                 {result.sentiment.headlines.map((headline, i) => (
//                                   <div key={i} className="text-sm text-muted-foreground pl-2 border-l-2 border-accent">
//                                     {headline}
//                                   </div>
//                                 ))}
//                               </div>
//                             )}
//                             <p className="text-sm text-muted-foreground whitespace-pre-wrap">{result.sentiment.summary}</p>
//                             <ConfidenceBar value={result.sentiment.confidence * 100} label="Confidence" />
//                           </div>
//                         </motion.div>
//                       )}
//                     </AnimatePresence>
...
//                               </div>
//                             )}
//                             <p className="text-sm text-muted-foreground whitespace-pre-wrap">{result.risk.summary}</p>
//                             <ConfidenceBar value={result.risk.confidence * 100} label="Confidence" />
//                           </div>
//                         </motion.div>
//                       )}
//                     </AnimatePresence>
